...
type ApiServiceMethodType<Payload, Return> = (payload: Payload, ref: string, behavior: 'debounce' | 'reset') => QueryResponse<Return>;

export class ApiService {
  private static memo: { [ref: string]: QueryResponse<any> | null } = {};

  private static query<T>(context: string, ref: string, endpoint: `/${string}`, payload?: object, options: RequestInit = {}): QueryResponse<T> {
  ...
  static subscribe: ApiServiceMethodType<{ email: string; }, string> = (payload, ref, behavior) => {
