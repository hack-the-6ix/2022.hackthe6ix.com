...
export interface TextareaProps extends HTMLAttributes<HTMLTextAreaElement>, Omit<InputLayoutProps, 'children'> {
  outlineColor?: Colors;
  limit?: number;
  value?: string;
}

function Textarea({ hideLabel, label, status, className, outlineColor, limit, ...props }: TextareaProps) {
