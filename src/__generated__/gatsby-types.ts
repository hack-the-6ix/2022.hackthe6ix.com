...
type SiteSiteMetadataApplications_startArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type SiteSiteMetadataApplications_endArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type SiteSiteMetadataFeatureFlags = {
  readonly applications: Maybe<Scalars['Boolean']>;
};
...
type SiteSiteMetadataSocialsFilterListInput = {
  readonly elemMatch: Maybe<SiteSiteMetadataSocialsFilterInput>;
};
...
type SiteSiteMetadataFeatureFlagsFilterInput = {
  readonly applications: Maybe<BooleanQueryOperatorInput>;
};
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.socials.type'
  | 'siteMetadata.socials.link'
  | 'siteMetadata.featureFlags.applications'
  | 'jsxRuntime'
  | 'polyfill'
  | 'pathPrefix'
  | 'trailingSlash'
...
type Unnamed_1_Query = { readonly sitePlugin: Maybe<Pick<SitePlugin, 'pluginOptions'>> };
